...
- The next \(n\) lines contain a string of length \(n\).
...
This fulfills the condition since the rows \(1, 2, \ldots, 5\) and the columns \(1, 2, \ldots, 5\) are all alphabetically sorted.
